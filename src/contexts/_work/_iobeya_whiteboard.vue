...
<template>
  <section class="challenge">
    <OneColumn
      :title="$t('work._iobeya_whiteboard.challenge.title')"
      :theme="theme"
    >
      <template #plain>
  ...
  <section>
    <OneColumn
      :title="$t('work._iobeya_whiteboard.part-1.title')"
      :theme="theme"
    >
      <template #plain>
  ...
  <section>
    <OneColumn
      :title="$t('work._iobeya_whiteboard.part-2.title')"
      :theme="theme"
    >
      <template #plain>
  ...
  <section>
    <OneColumn
      :title="$t('work._iobeya_whiteboard.part-3.title')"
      :theme="theme"
    >
      <template #plain>
    ...
    <FullWidthFigure center background="#262626" caption :theme="theme">
      <template #asset>
        <video
          ...
          poster=""
        >
          <source :src="assets._iobeya_whiteboard[12]" type="video/webm" />
          <source :src="assets._iobeya_whiteboard[13]" type="video/mp4" />
        </video>
      </template>
      <template #caption>
        <p class="discrete">
