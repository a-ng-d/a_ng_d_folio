...
<template>
  <figure class="figure">
    <div class="figure__asset" :class="isMagnified ? 'figure__asset--magnified' : null" @touchstart="magnifier" @click="magnifier" @wheel.passive="isMagnified = false" @touchmove.passive="isMagnified = false">
